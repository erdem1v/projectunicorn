...
- **Yer:** `scripts/autoload/{customer_registry,prospect_registry,promise_registry}.gd`, `scripts/data_models/{customer,prospect,promise}.gd`, `scripts/systems/` altında `sales_*`, `b2b_*`, `customer_rep_system`, `customer_archetypes`, `company_catalog`, `negotiation_system`, `pitch_system`; `scripts/tabs/sales_tab.gd`, `scripts/modals/{sales_meeting_scene,sales_stage,negotiation_scene}.gd`, `scenes/tabs/SalesTab.tscn`, `scenes/modals/{SalesMeetingScene,NegotiationScene}.tscn`
- **Sahip:** autoload `CustomerRegistry`, `ProspectRegistry`, `PromiseRegistry`; model `Customer`, `Prospect`, `Promise`; sınıf `SalesSystem`, `B2BSalesSystem`, `SalesFaucetSystem`, `SalesMeetingSystem`, `NegotiationSystem`, `SalesRepSystem`, `CustomerRepSystem`, `SalesLedger`, `SalesProbes`, `SalesFinalizer`, `SalesConstants`, `SalesArchetypes`, `SalesNamePool`, `B2BConstants`, `B2BEventFactory`, `CustomerArchetypes`, `CompanyCatalog`, `PitchSystem`; UI `SalesMeetingScene`, `SalesStage`, `NegotiationScene`
- **Giriş:**
